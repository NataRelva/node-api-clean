...
const makeSut = (): TypeSut => {
    ...
    const sut = new DbAuthentication(loadAccountByEmailRepository, hashComparerStub, tokenGeneration)
    return { sut, loadAccountByEmailRepository, hashComparerStub, tokenGeneration }
}
